        ...
        <div className="flex-column">
          ...
          <div className="card p-3 mb-4">
            <div className="corner-image-card-header">
              <h6 className="gray">
                <i>
                  {data.education.start} - {data.education.graduation}
                </i>
              </h6>
            ...
            <ul>
              ...
              <li>
                Dean's List {data.education.deansList} (top{" "}
                {data.education.deansListPercentile}% of college)
              </li>
              <li>
                {data.education.sat} / 1600 SAT (top{" "}
                {data.education.satPercentile}% of nation)
              </li>
          ...
          <a href={data.education.school.link} target="_blank" rel="noreferrer">
            <img
              src={data.education.school.image}
              alt={data.education.school.name + " Logo"}
